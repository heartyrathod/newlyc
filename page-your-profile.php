...
<main>
  ...
  <?php
    ...
    if ( isset( $_POST['profile_submit'] ) ) {
      ...
      $lyc_city = sanitize_text_field( $_POST['lyc_city'] );
      ...
      update_user_meta( $user_id, 'lyc_city', $lyc_city );
      wp_update_user( array( 'ID' => $user_id, 'user_email' => $email ) );

      if(isset($_FILES['wp-user-avatar']) && $_FILES['wp-user-avatar']!=null && $_FILES['wp-user-avatar']['size']>0){
          ...
          <div class="lyc-profile-content">
            <form class="lyc-profile-form" id="update-profile-form" method="post" enctype="multipart/form-data">
              <div class="row">
                ...
                $lyc_school = $current_user->lyc_school;
                $lyc_city = $current_user->lyc_city;
              ...
              ?>
                    ...
                    <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                      <div class="lyc-form-group">
                        ...
                        <input type="text" name="lyc_city" id="lyc_city" class="form-control" value="<?php echo esc_attr( $lyc_city ); ?>" placeholder="" required="" aria-required="true">
                      </div>
                    </div>
