...
<main>
  ...
  <section class="lyc-counsellors my-xxl-7 my-xl-7 my-lg-5 my-md-5 my-sm-3 my-3">
    <div class="container">
      ...
      <form action="" method="GET" class="lyc-search d-flex justify-content-end align-items-end">
        <span class="d-flex align-items-center gap-2">
          <input type="text" placeholder="Search by city" class="border-0" name="city" id="city">
          <select name="filter_city">
            <option value="">Filter by city</option>
            <?php
            // Get unique city values from user meta data
            $cities = get_users(array(
              ...
              'meta_query' => array(
                ...
                array(
                  'key' => 'lyc_city',
                  'compare' => 'EXISTS', // Check if the city meta field exists
                ),
              ),
            ));
          ...
          <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12 d-flex justify-content-end align-items-end">
            <div class="lyc-form-group">
              <label for="apply_for" class="lyc-required">City</label>
          ...
          if(isset($_GET['lyc_city']) && $_GET['lyc_city']!=''){
            $args1['meta_query'] = array(
                array(
                  'key'     => 'lyc_city',
                  'value'   => $_GET['lyc_city'],
                  'compare' => 'LIKE', // You can use 'LIKE' for partial matches
                ),
              );
          }
          ...
          $total_pages = intval($total_users / $number) + 1;
            // Modify user query based on city search and filter
            $args = array(
              'role' => 'um_counsellor',
              'orderby' => 'ID',
              'order' => 'DESC',
            ...
            // Add city search parameter if set
