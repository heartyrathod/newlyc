...
?>
	...
	<span class="d-flex align-items-center gap-2 mt-3">		
		<input type="text" id="<?php echo esc_attr( $twentytwentyone_unique_id ); ?>" class="form-control" value="<?php echo get_search_query(); ?>" name="s" autocomplete="off" required />
